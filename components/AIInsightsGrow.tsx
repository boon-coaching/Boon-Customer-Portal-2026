  ...
  const generateInsights = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${import.meta.env.VITE_SUPABASE_URL}/functions/v1/ai-generate-insights`,
        {
          method: 'POST',
          headers: {
      ...
      {!insights && !loading && !error && (
        <div className="text-center py-12">
          ...
          <p className="text-sm text-gray-500 max-w-md mx-auto mb-6">
            Analyze your program data with company context to generate executive-ready insights about leadership development progress.
          </p>
